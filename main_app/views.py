...
#     toys_cat_doesnt_have = Toy.objects.exclude(id_in=id_list)
#     feeding_form = FeedingForm()
#     return render(request, 'dogs/detail.html', {'dog': dog, 'feeding_form': feeding_form, 'toys': toys_cat_doesnt_have})
